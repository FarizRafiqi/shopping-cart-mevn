<template>
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <RouterLink :to="{ name: 'product.detail', params: { id: product.code } }">
            <div class="h-[300px]">
                <img class="object-cover w-full h-full" :src="asset(product.imageUrl)" :alt="product.imageUrl" />
            </div>
        </RouterLink>
        <div class="p-5">
            <RouterLink :to="{ name: 'product.detail', params: { id: product.code } }">
            ...
            <div class="flex items-center justify-between">
                ...
                <RouterLink :to="{ name: 'product.detail', params: { id: product.code } }" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300
